...
Difference between copy and original is loading of model from torch
'''
...
class bert_pred:
    def __init__(self, 
                 model_path='/home/slintel/bert_folder/pkl_model/model_2000_true_multiprocessed_decoding_false_cuda', 
